...
//        Log.d(TAG, "What is the ArrayList contents? Is it null? " + profileStation.get(position).keySet());
        ...
        switch(position){
            case 0:
                    if(imageCache != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.SELF)));
                        ...
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.SELF)));
            ...
            case 1:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.MUSIC)));
            ...
            case 2:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.SMIRKS)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if(profileStation != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.SMIRKS)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                    }
            ...
            case 3:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.SNAPS)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.SNAPS)));
                }
            ...
            case 4:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.VINES)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.VINES)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 5:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.FRIENDS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.FRIENDS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 6:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.MEMES)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.MEMES)));
                }
