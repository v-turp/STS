...
//        Log.d(TAG, "What is the ArrayList contents? Is it null? " + profileStation.get(position).keySet());
        ...
        switch(position){
            case 0:
                    if(imageCache != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DISPENSARY_LOCATOR)));
                        ...
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DISPENSARY_LOCATOR)));
            ...
            case 1:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DELIVERY_SERVICES)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if( profileStation != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DELIVERY_SERVICES)));
            ...
            case 2:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DOCTORS)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if(profileStation != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DOCTORS)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                    }
            ...
            case 3:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.STRAIN_GUIDE)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.STRAIN_GUIDE)));
                }
            ...
            case 4:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.ACCESSORIES)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.ACCESSORIES)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 5:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DAILY_DEALS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DAILY_DEALS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 6:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.NORML_NEWS)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.NORML_NEWS)));
                }
