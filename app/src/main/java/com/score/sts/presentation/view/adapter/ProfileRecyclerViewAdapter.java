...
//        Log.d(TAG, "What is the ArrayList contents? Is it null? " + profileStation.get(position).keySet());
        ...
        switch(position){
            case 0:
                    if(imageCache != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.BIO)));
            ...
            case 2:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.PICTURES)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if(profileStation != null){
            ...
            case 3:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.MESSAGE_AND_CHAT)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.MESSAGE_AND_CHAT)));
                }
            ...
            case 4:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.VIDEOS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.VIDEOS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 5:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.CONTACTS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.CONTACTS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 6:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.REGISTER_MATERIAL)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.REGISTER_MATERIAL)));
                }
