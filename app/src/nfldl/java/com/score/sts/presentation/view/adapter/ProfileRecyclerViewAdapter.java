...
//        Log.d(TAG, "What is the ArrayList contents? Is it null? " + profileStation.get(position).keySet());
        ...
        switch(position){
            case 0:
                    if(imageCache != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DRAFT_KINGS)));
                        ...
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DRAFT_KINGS)));
            ...
            case 1:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.FAN_DUEL)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if( profileStation != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.FAN_DUEL)));
            ...
            case 2:
                    if(imageCache != null) {
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.FANTASY_DRAFT)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                    }else if(profileStation != null){
                        holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.FANTASY_DRAFT)));
                        holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                    }
            ...
            case 3:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.DRAFT_DAY)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.DRAFT_DAY)));
                }
            ...
            case 4:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.MY_LEAGUE)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.MY_LEAGUE)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 5:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.LEAGUE_FRIENDS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.UPLOAD_ICON)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.LEAGUE_FRIENDS)));
                    holder.imageView.setImageDrawable(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.UPLOAD_ICON)));
                }
            ...
            case 6:
                if(imageCache != null) {
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), imageCache.get(ProfileActivity.YAHOO_NEWS)));
                }else if(profileStation != null){
                    holder.frameLayout.setBackground(new BitmapDrawable(context.getResources(), profileStation.get(position).get(ProfileActivity.YAHOO_NEWS)));
                }
